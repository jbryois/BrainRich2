...
```{r}
f <- "/Users/julienbryios/Documents/Data/Projects/Best_tissue2/Data/KI_lvl1/celltype_data_allKImouse_wtHypo_MergedStriatal_1to1only_level1_thresh0_trim0.rda"
```
...
exp_lvl5 %>% write_tsv(gzfile("../../02_Processed/Skene_lvl1.1to1.norm.txt.gz"))
```